...
class ChooseAudioForGeneratingSamplesView(BasicChooseAudioFile):
    ...
    def __init__(self, root, voice_model_service, voice_records_service):
        ...
        continue_button = tk.Button(self.root, text="Generate samples", command=self.switch_to_generating_samples, width=BUTTON_WIDTH_1,
    ...
    def switch_to_generating_samples(self):
        ...
        GenerateSamplesBasicView(self.root,self.voice_model_service, self.voice_recordings_service)
