...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        prog = 'WhisperTrans',
        description = 'Creates transcription for given set of audio files (in audiofiles/datasets/<dataset_name>) using whisper.'
        )
    ...
    parser.add_argument('-n', '--name', action='store', dest='dataset_name', 
